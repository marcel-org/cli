# Marcel CLI - Gamified productivity TUI application
BINARY_NAME=marcel
...
build:
	...
	@mkdir -p $(BUILD_DIR)
	cd src && go build $(LDFLAGS) -o ../$(BUILD_DIR)/$(BINARY_NAME) .
...
build-all: clean
	...
	@for platform in $(PLATFORMS); do \
		...
		cd src && GOOS=$$os GOARCH=$$arch go build $(LDFLAGS) -o ../$(DIST_DIR)/$$platform/$(BINARY_NAME) .; \
